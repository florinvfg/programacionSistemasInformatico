...
public class Examen {
    public static void main(String[] args) {
     /* // Definir los precios de los productos
        ...
        System.out.println("\tImporte a pagar (sin IVA): " + cuenta + " euros");
        System.out.println("\tIVA (" + (IVA * 100) + "%): " + (totalConIVA - cuenta) + " euros");
        System.out.println("\tImporte total a pagar (con IVA): " + totalConIVA + " euros");
        System.out.println("    ✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵");
    }
}
